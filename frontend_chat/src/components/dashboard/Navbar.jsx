      ...
      <div className="flex items-center gap-8">
         <div className="flex items-center gap-4 group cursor-pointer pl-4">
            <div className="flex flex-col items-end leading-none gap-2">
               <span className="text-[15px] font-black text-black tracking-tight group-hover:text-ayur-forest transition-colors uppercase italic">{patientName || 'PATIENT'}</span>
               <span className="text-[9px] font-black uppercase text-ayur-sage tracking-[2px]">Clinical Profile</span>
            </div>
