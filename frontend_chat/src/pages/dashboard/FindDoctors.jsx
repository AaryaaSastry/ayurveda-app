    ...
    <div className="h-full overflow-y-auto custom-scrollbar px-4 sm:px-6 md:px-8 lg:px-12 py-8">
      <div className="max-w-[1240px] mx-auto space-y-12 pb-20">
        ...
        {loading ? (
          ...
          <div className="col-span-full py-40 bg-[#fbfcfc] border-2 border-dashed border-[#f0f1f3] rounded-[48px] flex flex-col items-center justify-center text-center space-y-4">
            <MapPin size={64} className="text-ayur-sage/10 mb-2" />
            <h3 className="text-2xl font-bold text-ayur-forest">No doctors found nearby</h3>
            <p className="text-gray-400 font-medium max-w-[320px]">We couldn't find any certified practitioners matching your location. Try expanding your search radius.</p>
          </div>
        ) : (
